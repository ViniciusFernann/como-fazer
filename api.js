...
const baseURL = 'https://como-fazer-vinao.firebaseio.com/'
const auth = '5cJ1Qi3RVOn1eIaKkAx6hboPwdXdrlkvbLdnXGl2'
...
const get = async(key, id) => {
    const content = await axious.get(`${baseURL}/${key}/${id}.json?auth=` + auth)
    return {
        id: id,
        ...content.data
    }
